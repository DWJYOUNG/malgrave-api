"""
Django settings for malgrave_control_api project.
...
SECRET_KEY = 'django-insecure-%zx@(vinwigu8g7&_gw_5jh@14-r&b8cc05hgyd8yp6ado^-+u'
...
ROOT_URLCONF = 'malgrave_control_api.urls'
...
WSGI_APPLICATION = 'malgrave_control_api.wsgi.application'
